...
coverage:
	...
	@AK_MODEL_TEST_COVERAGE=1 ./node_modules/.bin/browserify -d ./test/index.js -t envify --ignore-missing > ./test/build.js
...
.PHONY: clean test buildtest validate coverage
